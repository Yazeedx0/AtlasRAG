...
from apps.api.routes.ingestion import extraction
from apps.api.routes.knowledge import document_artifacts, document_versions, documents
...
versioned_api_router.include_router(documents.router)
versioned_api_router.include_router(document_versions.router)
versioned_api_router.include_router(document_artifacts.router)
versioned_api_router.include_router(extraction.router)
